...
public abstract class AOEHarvestPick extends ItemPickaxe {
    public int breakRadius;
    public int breakDepth;

    public AOEHarvestPick(ToolMaterial baseDamage, int breakRadius, int breakDepth) {
        super(baseDamage);
    ...
    protected void breakExtraBlock(World world, int x, int y, int z, int sidehit, EntityPlayer playerEntity, int refX, int refY, int refZ) {
        ...
        // only effective materials... Not working for me, figure out later
