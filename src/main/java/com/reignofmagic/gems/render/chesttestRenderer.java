package com.reignofmagic.gems.render;
...
public class chesttestRenderer extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityAt(TileEntityTestChest p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof chesttest && i == 0)
            {
                try
                {
                ((chesttest)block).func_149954_e(p_147500_1_.getWorldObj(), p_147500_1_.xCoord, p_147500_1_.yCoord, p_147500_1_.zCoord);
                }
    ...
    {
        this.renderTileEntityAt((TileEntityTestChest)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}