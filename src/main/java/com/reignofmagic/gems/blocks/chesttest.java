...
public class chesttest extends BlockChest{

    private final Random field_149955_b = new Random();

	
	public chesttest(int chest){
		super(chest);
		setHardness(6F);
		setResistance(7F);
...
public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
{
    ...
    {
        ((TileEntityTestChest)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
    }
}
...
// Remove if you don't want double chest
public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
{
    super.onNeighborBlockChange(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, p_149695_5_);
    TileEntityTestChest tileentitychest = (TileEntityTestChest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);
...
{
    TileEntityTestChest tileentitychest = (TileEntityTestChest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
...
{
    Object object = (TileEntityTestChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
    ...
    else
    {
        ...
        {
            object = new InventoryLargeChest("Large Chest", (TileEntityTestChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
        }

        if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
        {
            object = new InventoryLargeChest("Large Chest", (IInventory)object, (TileEntityTestChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
        }

        if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
        {
            object = new InventoryLargeChest("Large Chest", (TileEntityTestChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
        }

        if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
        {
            object = new InventoryLargeChest("Large Chest", (IInventory)object, (TileEntityTestChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
        }
    ...
    {
        TileEntityTestChest tileentitychest = new TileEntityTestChest();
