...
public class gemPostDiamond extends Block{
	...
	@SideOnly(Side.CLIENT)
	  public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        this.icons[0] = iconRegister.registerIcon(Reference.MODID + ":" + "orePeridot");
        this.icons[1] = iconRegister.registerIcon(Reference.MODID + ":" + "oreSapphire");
        this.icons[2] = iconRegister.registerIcon(Reference.MODID + ":" + "oreRuby");
        this.icons[3] = iconRegister.registerIcon(Reference.MODID + ":" + "oreAmethyst");
        this.icons[4] = iconRegister.registerIcon(Reference.MODID + ":" + "oreJet");
