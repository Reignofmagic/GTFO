...
public class ModRecipes {
	...
	public static void LoadRecipes() 
	{
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.topazPickaxe),
                  ...
                  " P ",
                  " S ",
                  'X',new ItemStack(ModItems.Gemstones, 0), 'P', Items.stone_pickaxe, 'S', Items.stick
          );
		  ...
		  GameRegistry.addRecipe(new ItemStack(ModItems.topazAxe),
                  ...
                  "XP ",
                  " S ",
                  'X',new ItemStack(ModItems.Gemstones, 0), 'P', Items.stone_axe, 'S', Items.stick
          );
		  ...
		  GameRegistry.addRecipe(new ItemStack(ModItems.topazHoe),
                  ...
                  " P ",
                  " S ",
                  'X',new ItemStack(ModItems.Gemstones, 0), 'P', Items.stone_hoe, 'S', Items.stick
          );
		  ...
		  GameRegistry.addRecipe(new ItemStack(ModItems.topazSword),
                  ...
                  " X ",
                  " P ",
                  'X',new ItemStack(ModItems.Gemstones, 0), 'P', Items.stone_sword
          );
		  ...
		  GameRegistry.addRecipe(new ItemStack(ModItems.topazShovel),
                  ...
                  " P ",
                  " S ",
                  'X',new ItemStack(ModItems.Gemstones, 0), 'P', Items.stone_shovel, 'S', Items.stick
          );
		...
		//Malachite Tools
		  ...
		  CraftingManager
		  	.getInstance()
		  	.getRecipeList()
		  	.add(new ShapedOreRecipe(new ItemStack(ModItems.malachiteAxe), 
				  "XX ", 
				  "XP ", 
				  " S ", 
