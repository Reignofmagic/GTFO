...
public class ReignEventHandler implements IWorldGenerator {
	...
	private void generateSurface(World world, Random random, int x, int z) {
		...
		addOreSpawn(ModBlocks.gemOres, 7, Blocks.stone, world, random, x, z, 16, 16, 2 + random.nextInt(3), 4, 1, 12);//amethyst
		addOreSpawn(ModBlocks.gemOres, 8, Blocks.stone, world, random, x, z, 16, 16, 2 + random.nextInt(3), 4, 1, 12);//jet
