...
private void generateSurface(World world, Random random, int x, int z)
	{
	addOreSpawn(ModBlocks.oreTopaz, 0, Blocks.stone, world, random, x, z, 16, 16, 5 + random.nextInt(5), 32, 20, 60);
...
simply register all ores to spawn with this method in your generation method in your IWorldGeneration extending class
