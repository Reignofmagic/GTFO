...
//Armor
	   ...
	   public static Item.ToolMaterial gemAMETHYST = EnumHelper.addToolMaterial("gemAMETHYST", 3, 6073, 20F, 20F, 20);
	   public static Item.ToolMaterial gemJET = EnumHelper.addToolMaterial("gemJET", 3, 9110, 25F, 25F, 25);
	   ...
	   //Armor Material
	   public static ArmorMaterial gemTOPAZarmor = EnumHelper.addArmorMaterial("gemTOPAZarmor", 10, new int[]{2, 4, 3, 1}, 16);
	...
	public static void LoadItems()
	{
    	...
    	//Topaz
    	topazHelmet = new ItemTopazArmor(gemTOPAZarmor, 0, 0).setUnlocalizedName(Reference.MODID + "_" + "topazHelmet").setTextureName(Reference.MODID + ":" + "topazHelmet"); 	
    	RegisterHelper.registerItem(topazHelmet);
    	topazChest = new ItemTopazArmor(gemTOPAZarmor, 0, 1).setUnlocalizedName(Reference.MODID + "_" + "topazChest").setTextureName(Reference.MODID + ":" + "topazChest");	
    	RegisterHelper.registerItem(topazChest);
    	topazLegs = new ItemTopazArmor(gemTOPAZarmor, 0, 2).setUnlocalizedName(Reference.MODID + "_" + "topazLegs").setTextureName(Reference.MODID + ":" + "topazLegs"); 	
    	RegisterHelper.registerItem(topazLegs);
    	topazBoots = new ItemTopazArmor(gemTOPAZarmor, 0, 3).setUnlocalizedName(Reference.MODID + "_" + "topazBoots").setTextureName(Reference.MODID + ":" + "topazBoots");; 	
